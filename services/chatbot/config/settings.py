"""
Django settings for chatbot service.
"""
import os
...
DEBUG = env('DEBUG', default=True)  # Enable debug for troubleshooting
ALLOWED_HOSTS = ['*']
...
CACHES = {
    'default': {
        ...
        'LOCATION': env('REDIS_URL', default='redis://redis:6379/4'),
        'OPTIONS': {
...
# OpenAI API (optional - can use local model)
OPENAI_API_KEY = env('OPENAI_API_KEY', default='')
OPENAI_MODEL = env('OPENAI_MODEL', default='gpt-3.5-turbo')

# Courses Service URL (for context)
